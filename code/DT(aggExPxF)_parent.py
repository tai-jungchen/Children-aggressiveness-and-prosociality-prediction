"""
filename: DT(aggExPxF)_parent.py
...
def main():
	...
	# parent_data.to_csv('processed_DT(aggExPxF)_parent.csv')
	...
	parent_data1 = parent_data1.iloc[:1500]
	...
	# with open("DT(aggExPxF)_parent.log", "w") as fout:
