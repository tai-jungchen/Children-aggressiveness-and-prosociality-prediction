...
def main():
	...
	#agg_data.to_csv('processed_DT(brain).csv')
	...
	# with open("brain_decistion_tree.log", "w") as fout:
	# 	fout.write(text_representation)
	#
	# pred_data = pd.DataFrame(data=y_pred)
	# pred_data.to_csv('prediction_brain.csv')
